...
import com.cashless.self_order.util.extension.convertDateToDate
import com.cashless.self_order.util.extension.convertDateToString
import com.cashless.self_order.util.extension.convertUiFormatToDataFormat
...
object DateTimeUtils {
    ...
    fun replaceHHmm(date: String?, hour: String?, locale: Locale = Locale.JAPAN): String {
        ...
        val newDate = date?.convertUiFormatToDataFormat(
                ...
                locale = locale)
        val newDateTime = newDate + Constants.BLANK + hour
